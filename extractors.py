...
class YakeExtractor_Index(TwoStepKeywordExtractor):
    ...
    def train(self, documents, **kwargs):
        ...
        self.the_total_keywords =index_keywords+custom_kw_extractor.extract_keywords(total_data)
...
class KeyBertExtractor(TwoStepKeywordExtractor):
    def train(self, documents, **kwargs):
        ...
        self.the_total_keywords = extractor.extract_keywords(' '.join(documents),   keyphrase_ngram_range=(1, 5))[:self.total_keywords_in_training]
